<?php
  ...
  echo '<br/>';
  echo '<p>Kérünk Titeket, hogy a foglalt időpont előtt legkésőbb <strong>két nappal</strong> utaljátok el a <strong>'.
  (isset($voucher) ? $voucher->discounted_price : '12000').
  ' Ft foglalási összeget</strong> számlaszámunkra, különben foglalásotok törlésre kerül! Köszönjük!</p>';
  echo '<br/>';
