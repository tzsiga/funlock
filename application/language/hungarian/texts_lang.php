...
$lang['menuitem_3_text']      = '1068 Budapest<br/>Hegedű utca 1.<br/><br/>+3630 563 1895<br/><p id="info">&nbsp;</p><br/><a href="http://goo.gl/maps/AriVW" target="_blank"><img id="map" src="'.base_url().'assets/img/main/map.png" alt="" title=""/></a>';
...
$lang['legend_1']             = "Nem elérhető";
$lang['legend_2']             = "Szabad";
$lang['legend_3']             = "Foglalt";

$lang['book-fname']           = "Vezetéknév";
$lang['book-sname']           = "Keresztnév";
$lang['phone']                = "Telefon";
$lang['payment-option']       = "Fizetés";
$lang['payment-option-1']     = "átutalással";
$lang['payment-option-2']     = "készpénzzel";
$lang['voucher']              = "Kupon";
$lang['email']                = "Email";
$lang['billing']              = "Számlázási adatok különböznek";
$lang['bill-fname']           = "Vezetéknév";
$lang['bill-sname']           = "Keresztnév";
$lang['tax-number']           = "Adószám";
$lang['zip']                  = "Ir.szám";
$lang['city']                 = "Város";
$lang['street']               = "Utca";
$lang['house']                = "Házszám";
$lang['eula']                 = 'Elfogadom a <a href="'.base_url().'index.php/pages/eula" id="link-eula" data-fancybox-type="iframe">feltételeket</a>';
$lang['book-btn']             = "Foglalás";
...
$lang['eula_text']            = "
    ...
    <ol>
      ...
      <li>Mivel az instrukciók és játékszabályok betartásával mindennemű baleset elkerülhető, az üzemeltető ezekért, valamint a személyi sérülésekért semminemű felelősséget nem vállal, ideértve az anyagi károkat is</li>
      <li>Amennyiben a játékot műszaki hiba miatt meg kell szakítani, az üzemeltető újabb időpontot ajánl fel a csapatnak, de pénzvisszafizetésre nem kötelezhető</li>
      <li>Amennyiben egy csapat késve érkezik, az üzemeltető jogosult a játékidőt a késés mértékével csökkenteni, hogy megelőzze a csúszásból adódó torlódást</li>
    </ol>";
